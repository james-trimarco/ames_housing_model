...
```{r}
write.csv(data.frame(preds_l), row.names = T, file = "/Users/james/Documents/NCDS/Semester_2/Inference_II/ames_housing_model/Kaggle_Data/predictions_l.csv")
```
